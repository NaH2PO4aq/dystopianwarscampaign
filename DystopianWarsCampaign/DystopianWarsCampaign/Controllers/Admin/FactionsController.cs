...
namespace DystopianWarsCampaign.Controllers.Admin
{
    public class FactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Acronym,FlagURL,HomeFleet,AwayFleet")] Faction faction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Acronym,FlagURL,HomeFleet,AwayFleet")] Faction faction)
        {
            if (ModelState.IsValid)
            {
