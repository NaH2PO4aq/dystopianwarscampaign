...
namespace DystopianWarsCampaign.Controllers.Admin
{
    public class TerritoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,FlagXCoord,FlagYCoord")] Territory territory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,FlagXCoord,FlagYCoord")] Territory territory)
        {
            if (ModelState.IsValid)
            {
